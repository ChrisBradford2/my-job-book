    ...
    <li className="job-list-item border p-4 rounded-lg shadow-sm bg-white">
      ...
      <div className="flex flex-col md:relative md:block space-y-2 md:flex-row md:space-x-4 md:space-y-0">
        ...
        <button
          ...
          className={`w-full py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 sm:w-auto sm:px-4 sm:py-2 md:absolute md:top-1/2 md:-translate-y-1/2 md:right-0 ${
            job.status === 'Offer received' || job.status === 'Rejected' ? 'bg-gray-500 cursor-not-allowed' : 'bg-indigo-600 hover:bg-indigo-700'
          }`}
