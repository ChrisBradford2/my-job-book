...
const JobOfferRow: React.FC<JobOfferRowProps> = ({ job, handleDelete, handleEdit, openStatusModal }) => {
  ...
  return (
    <tr key={job.id} className="bg-white border-b">
      ...
      <td className="py-4 px-6">{job.applicationDate ? new Date(job.applicationDate).toLocaleDateString() : ''}</td>
